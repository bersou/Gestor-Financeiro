...
const Header = () => {
  return (
    <motion.header
      ...
      className="relative flex items-center justify-center gap-4 p-8 md:p-10 rounded-3xl overflow-hidden bg-gradient-to-br from-primary via-primary/90 to-accent"
    >
      {/* Decorative blobs */}
