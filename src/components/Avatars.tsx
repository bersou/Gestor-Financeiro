const avatars: Record<string, () => JSX.Element> = {
  Carmelita: () => (
    <svg viewBox="0 0 100 100" className="w-full h-full">
      ...
      <circle cx="38" cy="48" r="4.5" fill="#374151" className="avatar-eye" />
      <circle cx="62" cy="48" r="4.5" fill="#374151" className="avatar-eye-delayed" />
      <circle cx="28" cy="58" r="5" fill="#fca5a5" opacity="0.5" />
      <circle cx="72" cy="58" r="5" fill="#fca5a5" opacity="0.5" />
      <path d="M 44 68 Q 50 74 56 68" fill="none" stroke="#b45309" strokeWidth="2.5" strokeLinecap="round" className="avatar-mouth" />
    </svg>
  ),
  "Cláudio": () => (
    <svg viewBox="0 0 100 100" className="w-full h-full">
      ...
      {/* Bigode */}
      <path d="M 35 63 Q 42 58 50 62 Q 58 58 65 63 Q 58 66 50 64 Q 42 66 35 63 Z" fill="url(#beard-man)" />
      {/* Cavanhaque */}
      <path d="M 40 72 Q 50 85 60 72 Q 55 80 50 82 Q 45 80 40 72 Z" fill="url(#beard-man)" />
      {/* Cabelo */}
      ...
      {/* Olhos */}
      <circle cx="38" cy="46" r="4.5" fill="#1e293b" className="avatar-eye" />
      <circle cx="62" cy="46" r="4.5" fill="#1e293b" className="avatar-eye-delayed" />
      {/* Sobrancelhas */}
      ...
      {/* Boca */}
      <path d="M 45 71 Q 50 75 55 71" fill="none" stroke="#fcd34d" strokeWidth="2" strokeLinecap="round" className="avatar-mouth" />
    </svg>
  ),
  "Cecília": () => (
    <svg viewBox="0 0 100 100" className="w-full h-full">
      ...
      <circle cx="38" cy="48" r="4.5" fill="#1e293b" className="avatar-eye" />
      <path d="M 32 46 Q 38 42 43 46" fill="none" stroke="#1e293b" strokeWidth="2" strokeLinecap="round" />
      <circle cx="62" cy="48" r="4.5" fill="#1e293b" className="avatar-eye-delayed" />
      ...
      <path d="M 44 66 Q 50 72 56 66" fill="none" stroke="#78350f" strokeWidth="2.5" strokeLinecap="round" className="avatar-mouth" />
    </svg>
  ),
  "Valmor": () => (
    <svg viewBox="0 0 100 100" className="w-full h-full">
      ...
      <path d="M 44 66 Q 50 72 56 66" fill="none" stroke="#92400e" strokeWidth="2.5" strokeLinecap="round" className="avatar-mouth" />
    </svg>
  ),
};
